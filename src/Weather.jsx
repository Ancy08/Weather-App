...
function Weather() {
    ...
    return (
        ...
        <div className="text-white min-h-screen w-screen bg-cover bg-center relative" style={{ backgroundImage: `url(${getBackgroundImage()})`, transition: "background-image 0.5s ease-in-out", filter: "brightness(0.85)" }}>
